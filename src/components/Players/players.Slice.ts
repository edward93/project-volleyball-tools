...
export const playersSlice = createSlice({
  ...
  name: "players",
  reducers: {
    addPlayers: (state: Players, action: PayloadAction<Player[]>) => {
...
export const { updatePlayerInfo, updatePlayerName, subPlayers, rotatePlayers, addPlayers } = playersSlice.actions;
