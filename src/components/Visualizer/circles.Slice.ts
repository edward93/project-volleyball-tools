...
export const circles: Circle[] = [
  { id: ids[0], cx: 450, cy: 190, r: 40, color: "red", playerId: ids[0] },
  { id: ids[1], cx: 800, cy: 190, r: 40, color: "blue", playerId: ids[1] },
  { id: ids[2], cx: 1130, cy: 190, r: 40, color: "green", playerId: ids[2] },
  { id: ids[3], cx: 450, cy: 590, r: 40, color: "red", playerId: ids[3] },
  { id: ids[4], cx: 800, cy: 590, r: 40, color: "blue", playerId: ids[4] },
  { id: ids[5], cx: 1130, cy: 590, r: 40, color: "green", playerId: ids[5] },
];
